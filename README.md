...
## About this module
This module for Testerra framework provides access to mobile devices. Based on Appium you can create and execute automated tests on mobile browsers or native apps.
