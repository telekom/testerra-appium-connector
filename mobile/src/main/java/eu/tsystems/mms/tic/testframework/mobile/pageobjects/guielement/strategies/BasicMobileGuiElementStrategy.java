...
public class BasicMobileGuiElementStrategy implements MobileGuiElementStrategy {
    ...
    private int timeoutInSeconds = PropertyManager.getIntProperty(TesterraProperties.ELEMENT_TIMEOUT_SECONDS, 30);
    private int timerSleepTimeInMs = 1000;
    ...
    public boolean waitForIsDisplayed() {
        ...
        return waitForDisplayedStatus(true);
    }

    @Override
    public boolean waitForIsNotDisplayed() {

        return waitForDisplayedStatus(false);
    }
    ...
    public boolean waitForPropertyValue(String property, String value) {
        ...
        return waitForPropertyStatus(property, value, false);
    }

    @Override
    public boolean waitForPropertyContains(String property, String value) {

        return waitForPropertyStatus(property, value, true);
    }
    ...
    @Override
    @Deprecated
    public void setContainingPage(MobilePage page) {
        // ntohing to do here, because cache is done internally now.
    }
