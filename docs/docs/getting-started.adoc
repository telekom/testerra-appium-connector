...
For mobile tests you have to reserve and release the device that you want to use for your test in a configuration method like `@BeforeSuite` and `@AfterMethod`.
